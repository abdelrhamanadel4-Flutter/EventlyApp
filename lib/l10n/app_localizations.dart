...
abstract class AppLocalizations {
  ...
  /// No description provided for @chooseYourPreferredThemeAndLanguage.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @diveIntoAWorldOfEvents.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @takeTheHussleOutOfOrganizingEventsWithOurAllInOnePlanningTools.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @makeEveryEventMemorableBySharingTheExperienceWithOthers.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @forgetPasswordnot.
  ///
  /// In en, this message translates to:
  /// **'Forget Password'**
  String get forgetPasswordnot;
